...
namespace Granta.MaterialsWall.Models
{
    public sealed class Card
    {
        ...
        public Card(Guid identifier, string name, string id, string description, string typicalUses, string source, string sample, string path, Image[] images, Link[] links)
        {
